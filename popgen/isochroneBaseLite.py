...
import popgen.imf as imf
from popgen.modelBase import Model, Parameter
from popgen.utils import norm_cdf, get_ugali_dir, get_iso_dir, mod2dist, sum_mags
from popgen.config import Config
from popgen.logger import logger

import pathlib #pathlib.Path(dirname).mkdir(parents=True, exist_ok=True)
...
class IsochroneModel(Model):
    ...
    def _setup(self, **kwargs):
        ...
        self.imf = imf.imfFactory(defaults['imf_type'])
        self.index = None
